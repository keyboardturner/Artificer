...
local Defaults = {
	...
	NameplateStatusColors = {
		...
		group_member = { r=1, g=1, b=0, a=1, desat = false, },
		group_assist = { r=1, g=1, b=0, a=1, desat = false, },
		group_leader = { r=1, g=1, b=0, a=1, desat = false, },

		guild_member = { r=0, g=1, b=0, a=1, desat = false, },

		friend_character = { r=1, g=1, b=1, a=1, desat = false, },
		friend_account = { r=1, g=1, b=1, a=1, desat = false, },
		friend_bnet = { r=1, g=1, b=1, a=1, desat = false, },
